...
@section('content')
                    ...
                    <div class="card-body" style="padding-top: 0.2rem;">
                        <div class="container">
                            <div class="form-row mt-3">
                                <div class="col-md-12"><h5 style="color: #1492E6; font-size: 20px;">Programa - {{$programa->nome}}</h5></div>
                                <div class="col-md-12"><h6 style="color: #234B8B; margin-bottom:-0.4rem; font-weight: bold; font-size: 14px;">Propostas Vinculadas</h6><br></div>
                                <div class="col-md-12">
                                    <select id="" class="form-control select-submeta" onchange="teste(this)" style="width: 200px;">
                                        <option value="todos" selected>Todos</option>
                                        <option value="aprovado">Aceitos</option>
                                        <option value="reprovado">Não Aceitos</option>
    ...
    <div id="projetos">
        @foreach( $trabalhos as $trabalho )
            ...
            <div class="row justify-content-center allTrab apareceu {{ $trabalho->programa_extensao_status ?? 'pendente' }}" style="margin-top: 20px;" >
                <br>
                <div class="col-md-11">
                    <div class="card" style="border-radius: 5px;margin-left: 25px;margin-right: 25px;">
                        <div class="card-body" style="padding-top: 0.2rem; padding-left: 25px;padding-right: 25px;">
                            ...
                            <div class="form-row mt-3">
                                ...
                                <div class="col-md-2">
                                    @if($trabalho->programa_extensao_status == "aceito")
                                    ...
                                    @elseif($trabalho->programa_extensao_status == "rejeitado")
                            ...
                            <div class="form-row mt-3">
                                ...
                                @if($trabalho->grande_area_id != null && $trabalho->area_id == null && $trabalho->sub_area_id == null)
                                    <div class="col-md-12">
                                        <h6 style="color: #234B8B; font-weight: bold;font-size: 13px;">{{$trabalho->grandeArea->nome}}</h6>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="form-row mt-3 justify-content-start">
                                <div class="col-md-3 mx-4">
                                    <a href="{{route('admin.analisarProposta',['id'=>$trabalho->id])}}" class="btn btn-light" style="width:100%">Visualizar</a>
                                </div>
